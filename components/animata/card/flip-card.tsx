...
export default function FlipCard({
  ...
  return (
    <div
      className={cn("group h-60 w-56 [perspective:1000px]", className)}
      {...props}
    >
      <div
        className={cn(
      ...
      >
        ...
        >
          <div className="flex min-h-full flex-col gap-2">
            ...
            <p className="mt-1 border-t border-t-gray-300 py-4 text-sm font-medium leading-normal text-black">
              {description}
            </p>
          </div>
        </div>
